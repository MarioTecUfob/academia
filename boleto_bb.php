...
//pegando os dados da tabela no banco de dados
$cpfconsulta=$_POST['valor'];
session_start();
include_once("conexao.php");
$tsql = "select nome,rg,cpf,cep,logradouro,cidade,estado,data_nasc,mensalidade from matricula where cpf=$cpfconsulta";
...
$valor_boleto=number_format($mensalidade, 2, ',', '');
